...
final class Version20250902104023 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE avis ADD CONSTRAINT FK_8F91ABF089986428 FOREIGN KEY (id_serie_id) REFERENCES series (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE avis ADD CONSTRAINT FK_8F91ABF088E2F8F3 FOREIGN KEY (id_film_id) REFERENCES films (id) ON DELETE CASCADE');
    }
